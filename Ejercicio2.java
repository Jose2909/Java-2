...
public class Ejercicio2{
	...
	public void separeOddsEvens(){
		...
		encap.getNumaux();
		encap.setLen(20);
		int leng = encap.getLen();
		encap.setRdmnumber(100);
		int randoms = encap.getRdmnumber();
		...
		int [] listRnd = new int [leng];
		
		System.out.println("Arreglo : \n ");
		for(int numrnd=0; numrnd < listRnd.length; numrnd++){ 
          numaux = rnd.nextInt(randoms); 
    ...
    public void numbers0to20(){
    	...
    	encap2.setLen(20);		
		int leng = encap2.getLen();
		encap2.setLmit(21);	
		int limites = encap2.getLimit();
